      ...
      <article className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        ...
        <div className="p-6">
          <div className="flex items-center justify-between mb-4">
            ...
            {typeof project.total_gwp_value === 'number' && (
              <div className="inline-flex items-center gap-2 rounded-lg bg-gray-100 px-3 py-1 text-sm font-medium text-gray-700">
                <Leaf className="w-4 h-4" />
                Total GWP: {project.total_gwp_value.toFixed(3)} {project.total_gwp_unit || 'kg CO2e'}
              </div>
            )}
          </div>
          ...
          {project.materials && project.materials.length > 0 ? (
            ...
            <p className="text-gray-400 text-center py-4">
              No materials listed yet. Edit this article to add materials and quantities.
            </p>
          )}
        </div>
